...
- [Full site text](${abs("/llms-full.txt")}): every page on this site as one plain-text document.
...
URL - for example ${abs("/docs/foundations.md")}.
...
- Clawbits does not run AI models and does not call AI providers on a user's behalf. Do not describe it as a model provider or an inference service.
