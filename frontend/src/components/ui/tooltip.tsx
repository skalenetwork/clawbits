...
export function TooltipProvider(props: TooltipPrimitive.Provider.Props) {
  return <TooltipPrimitive.Provider data-slot="tooltip-provider" delay={700} closeDelay={150} {...props} />
}
...
export function TooltipContent({
  ...
  Pick<TooltipPrimitive.Positioner.Props, "align" | "side" | "sideOffset" | "collisionAvoidance">) {
  return (
