          ...
          <span className="access-flip">
            ...
            <span className="access-face access-back">
              ...
              <span className="access-marks">
                {kinds.map((kind) => {
                  const at = marks.find((m) => m.kind === kind)?.earned_at;
                  return (
                    <span key={kind} data-on={at ? "" : undefined}>
                      <i />
                      <span className="access-what">{MARK_COPY[kind].title}</span>
                      <span className="access-when">{at ? formatMarkDate(at) : "Not yet"}</span>
                    </span>
                  );
                })}
              </span>
